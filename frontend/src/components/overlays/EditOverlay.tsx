                    ...
                    >
                            ...
                            <div key={field.name}>
                                ...
                                {field.options ? (
                                    <select
                                        ...
                                        className="w-full rounded border border-[#6ADBAF] bg-white p-1.5 text-sm text-[#111827] dark:bg-[#0E1F48] dark:text-[#F9FAFB] sm:p-2 sm:text-base"
                                        required
                                    >
                                        <option value="">
                                            {t("common.select")}
                        ...
                        <div className="flex justify-end gap-2 sm:gap-3">
                            ...
                            <button
                                type="button"
                                onClick={onClose}
                                className="cursor-pointer rounded border border-[#6ADBAF] px-3 py-1.5 text-sm transition-colors hover:bg-gray-100 dark:hover:bg-white/10 sm:px-4 sm:py-2 sm:text-base"
                            >
                                {t("common.cancel")}
                            </button>
